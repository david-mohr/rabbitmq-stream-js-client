...
export declare class ConnectionPool {
    ...
    static getUsableCachedConnection(purpose: ConnectionPurpose, streamName: string, vhost: string, host: string): Connection | undefined;
    static cacheConnection(purpose: ConnectionPurpose, streamName: string, vhost: string, host: string, client: Connection): void;
